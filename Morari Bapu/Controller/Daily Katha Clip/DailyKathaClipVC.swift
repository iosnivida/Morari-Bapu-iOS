...
class DailyKathaClipVC: UIViewController {
...
extension DailyKathaClipVC: MenuNavigationDelegate{
...
extension DailyKathaClipVC : UITableViewDelegate, UITableViewDataSource{
...
//        }
        ...
        cell.btnPlayList.tag = indexPath.row
...
//        cell.btnFavourite.addTarget(self, action: #selector(btnFavourite), for: UIControl.Event.touchUpInside)
        ...
        cell.btnPlayList.addTarget(self, action: #selector(btnPlayList), for: UIControl.Event.touchUpInside)
    ...
    @IBAction func btnPlayList(_ sender: UIButton) {
        ...
        //Daily Katha Clip
        let storyboard = UIStoryboard(name: Media_Storyboard, bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "DailyKathaClipSliderVC") as! DailyKathaClipSliderVC
        vc.arrVideo = arrVideo
...
extension DailyKathaClipVC : InternetConnectionDelegate{
